...
import com.nopcommerce.pages.BillingPage;
...
public class ComputerTest extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        billingPage.enterFirstname("Maria");
        billingPage.enterLastname("Smith");
        billingPage.enterEmail("mariasmith@gmail.com");
        billingPage.selectCountry("United Kingdom");
        billingPage.enterCity("London");
        billingPage.enterAddress("23, Dublin road");
